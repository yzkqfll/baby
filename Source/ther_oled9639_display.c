...
static unsigned char dump_24x13[39] = {
...
static void oled_show_temp(bool show, unsigned short temp)
{
	...
	if (show) {
		...
		oled_drv_write_block(2, 5, 39, 47, dot_24_8[0]);
...
{
	if (show) {
		oled_drv_write_block(2, 5, 10, 23, dump_24x13);
		oled_drv_write_block(2, 5, 23, 36, dump_24x13);

		oled_drv_write_block(2, 5, 39, 47, dot_24_8[0]);

		oled_drv_write_block(2, 5, 50, 63, dump_24x13);
